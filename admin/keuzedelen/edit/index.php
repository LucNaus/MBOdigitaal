...
// wordt getoond.
// Informatie van bestaande keuzedelen wordt opgehaald uit de database.
...
if (!$keuzedeel) {
    $message = "Het is niet gelukt om het keuzedeel met de id $id op te halen.";
...
$title = "Formulier keuzedelen bewerken";
$editmode = true;
