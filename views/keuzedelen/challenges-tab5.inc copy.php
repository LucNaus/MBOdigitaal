<h3 class="text-xl font-bold ">Overzicht van alle keuzedelen</h3>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 ">
                ...
                <tbody> 
                        <tr
                            ...
                            <td class="px-6 py-4">
                                Basis programmeren van games <!-- title -->
                            </td>
                            <td class="px-6 py-4">
                                240 <!-- sbu -->
                            </td>
                            ...
                            <td class="px-6 py-4">
                                Verdiepend, Verbredend <!-- goalsDescription -->
                            </td>
                            <td class="px-6 py-4">
                                FALSE <!-- preconditions -->
                            </td>
                            <td class="px-6 py-4">
                                locatie Apeldoorn <!-- teachingMethods -->
                            </td>
                            <td class="px-6 py-4">
                                FALSE <!-- certificate -->
                            </td>
